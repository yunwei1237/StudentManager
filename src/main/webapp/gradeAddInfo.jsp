...
<script type="text/javascript" src="js/myjs/gradeAddInfo.js"></script>
</head>
...
<body>
	<div class="container" style="width:80%;">
		...
		<div class="content" style="min-height: 450px">
			<form id="frm_addGrade" class="form-horizontal" role="form">
					<h4 class="text-center"><strong>添加年级信息</strong></h4><br/>
