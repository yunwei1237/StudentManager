...
<script type="text/javascript" src="js/myjs/gradeModifyInfo.js"></script>
</head>
...
<body>
	<div class="container" style="width:80%;">
		...
		<div class="content" style="min-height: 450px">
			<form id="frm_updateGrade" class="form-horizontal" role="form">
					<div>
						<input type="hidden" id="id" name="id" value="${param.id }"/>
						<input type="hidden" id="isDelete" name="isDelete"/>
					</div>
					<h4 class="text-center"><strong>编辑年级信息</strong></h4><br/>
					<div class="form-group">
						<label for="firstname" class="col-sm-offset-2 col-sm-2 control-label">年级名称</label>
						<div class="col-sm-4">
